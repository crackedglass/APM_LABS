...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . ndedipnfq1 ) , 0 , 0 , 8 } ,
{ ( char_T * ) ( & rtDW . jofco0taut . AQHandles ) , 11 , 0 , 7 } } ; static
DataTypeTransitionTable rtBTransTable = { 2U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . Kd ) , 0 ,
0 , 11 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
